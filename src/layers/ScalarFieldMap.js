import Cell from './vector/Cell';
import {CanvasLayerField} from './vector/L.CanvasLayer.Field'
/**
 * ScalarField on canvas (a 'Raster')
 */
export var ScalarFieldMap = CanvasLayerField.extend({
    options: {
    ...
    initialize: function(scalarField, options) {
        CanvasLayerField.prototype.initialize.call(
            this,
            scalarField,
            options
        );
